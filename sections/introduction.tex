...
We developed a modular framework that structures strategies as Directed Acyclic Graphs (DAGs). This system utilizes distinct "nodes" to execute specific tasks, such as retrieving asset data, calculating technical indicators, or evaluating logical conditions. Additionally, we integrated AI prediction nodes that employ LSTM models to forecast future prices. This architecture allows for the combination of deterministic trading rules with probabilistic machine learning predictions in a structured manner, drawing on concepts from flow-based programming \cite{paleyes2022empirical}.
